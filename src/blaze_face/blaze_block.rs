...
impl BlazeBlock {
    ...
    pub fn new(
        ...
        let block_type = match stride {
            | StrideType::Single => {
                BlazeBlockType::SingleStride(BlazeBlockSingleStride::new(
                    in_channels,
                    out_channels,
                    kernel_size,
                    weight_0,
            ...
            | StrideType::Double => {
                BlazeBlockType::DoubleStride(BlazeBlockDoubleStride::new(
                    in_channels,
                    out_channels,
                    weight_0,
                    bias_0,
